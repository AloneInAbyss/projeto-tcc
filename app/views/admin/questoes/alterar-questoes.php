...
<head>
	...
	<title>Alteração de Questões</title>
	...
	<div class="container">
		<div class="row">
			<div class="offset-2 col-8">
                ...
                <br><br>
				<form class="form-signin" method="post" action="/alterar-questoes">
					<label for="inputText">Digite o ID</label>
					<input type="text" id="inputText" class="form-control" placeholder="ID" name="id" required>
				</form>
				<br>
				<table class="table table-dark">
            		...
            		?>
						<tr>
							...
							<td>
								<form class="form-inline my-2 my-lg-0" method="post" action="/modificar-questoes">
									<input type="hidden" value="<?php echo $linha['id']; ?>" name="id">
									<button class="btn btn-outline-success my-2 my-sm-0" name="formAlterarQuestoes" type="submit" value="ir">Alterar</button>
								</form>
							</td>
						</tr>
					<?php 
