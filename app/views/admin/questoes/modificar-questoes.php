                ...
                <div class="row">
                    <div class="offset-1 col-10">
                        <form class="form-signin" method="post" action="/modificar-questoes">
                            ...
                            <input type="text" id="inputQuestao" class="form-control" placeholder="Questão" value="<?php echo $questao ?>" name="questao" maxlength="255" required>
                            <br>
                            ...
                            <input type="text" id="inputResolucao" class="form-control" placeholder="Resolução" value="<?php echo $resolucao ?>" name="resolucao" maxlength="255" required>
                            <br>
                            ...
                            <button class="btn btn-lg btn-primary btn-block" type="submit" name="formModificarQuestoes">Modificar</button>
                        </form>
