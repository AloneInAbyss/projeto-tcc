...
<div class="container">
    <div class="row">
        <div class="offset-lg-2 col-lg-8">
            ...
            <br><br>
            <form class="form-signin" method="post" action="/deletar-admin">
                <label for="inputText">Digite o ID</label>
                <input type="text" id="inputText" class="form-control" placeholder="ID" name="idSearch" required>
            </form>
            <br>
            <table class="table table-dark">
                ...
                <tr>
                    ...
                    <td>
                        <form class="form-inline my-2 my-lg-0" method="post" action="/deletar-admin">
