            ...
            <div class="offset-lg-2 col-lg-8">
                <h1 style="border-bottom: 1px solid #f1f1f1">
                    ...
                    <span class="float-right">
                        <a style="text-decoration: none; font-size: 0.7em; color: #a1a1a1;" href="/alterar-admin">
                            Voltar
                        </a>
                    </span>
                </h1>
                ...
                <div class="row">
                    <div class="offset-1 col-10">
                        <form class="form-signin" method="post" action="/modificar-admin">
                            ...
                            <button class="btn btn-lg btn-primary btn-block" name="formAlterarUsuarios" type="submit">Alterar</button>
                        </form>
