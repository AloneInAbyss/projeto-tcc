                ...
                <div class="row">
                    <div class="offset-1 col-10">
                        <form class="form-signin" method="post" action="/inserir-admin">
                            ...
                            <input type="email" id="inputEmail" class="form-control mt-1" placeholder="Ex: joao@hotmail.com" name="email" maxlength="50" required>
                            <br>
                            
                            <label for="inputPassword">Senha</label>
                            <input type="password" id="inputPassword" class="form-control mt-1" placeholder="Digite uma senha" name="senha" maxlength="20" required>
                            <br>

                            <label for="inputName">Nome de exibição</label>
                            <input type="text" id="inputName" class="form-control mt-1" placeholder="Ex: Toni Garrido" name="nome" maxlength="25" required>
                            <br>
