                ...
                <div class="row">
                    <div class="offset-1 col-10">
                        <form class="form-signin" method="post" action="/inserir-resumos">
                            ...
                            <input type="text" id="inputNome" class="form-control" placeholder="Ex: Ácidos, Bases e Sais" name="nome" maxlength="255" required>
                            <br>
                            ...
                            <input type="text" id="inputSubmateria" class="form-control" placeholder="Ex: Química Orgânica" name="submateria" maxlength="255" required>
                            <br>

                            <label for="inputDescricao">Descrição</label>
                            <input type="text" id="inputDescricao" class="form-control" placeholder="Digite uma descrição" name="descricao" maxlength="255" required>
                            <br>

                            <label for="inputResumo">Resumo</label>
                            <br>
                            <textarea class="form-control" name="resumo" id="inputResumo" rows="5" placeholder="Digite o resumo" required></textarea>
                            <br>
