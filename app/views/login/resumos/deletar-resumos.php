    ...
    <div class="container">
        <div class="row">
            <div class="offset-lg-2 col-lg-8">
                ...
                <br><br>
                <form class="form-signin" method="post" action="/deletar-resumos">
                ...
                <table class="table table-dark">
                    ...
                    <?php 
                        if (isset($_POST['idSearch']) && $_POST['idSearch'] <> "") {
                            $result = mysqli_query($connection,"SELECT * FROM resumos WHERE id =".$_POST['idSearch']);
                    ...
                    ?>
                        <tr>
							...
							<td>
								<form class="form-inline my-2 my-lg-0" method="post" action="/deletar-resumos">
